...
<div class="modal fade" id="tabModal" tabindex="-1" aria-labelledby="tabModalLabel" aria-hidden="true">
 ...
 <%--                                       <li class="nav-item" role="presentation">
  ...
  <%--  <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js"></script>
    ...
    //                    var name = row.find("td:nth-child(1)").text();
    //                    var housenumber = row.find("td:nth-child(2)").text();
    //                    var neigbourhod = row.find("td:nth-child(3)").text();
    //                    var subneighbourhood = row.find("td:nth-child(4)").text();
    //                    var contactnumber = row.find("td:nth-child(5)").text();
    //                    var monthyear = row.find("td:nth-child(6)").text();
    //                    var amountneeded = row.find("td:nth-child(7)").text();
    ...
    //    ** Neighbourhood   : ${neigbourhod}
    //    ** Sub-Neighbourhood: ${subneighbourhood}
    ...
    //                        printWindow.document.write('<pre style="font-family: monospace; font-size: 12px; line-height: 1.5; background-color: #f4f4f4; padding: 10px;">' + content + '</pre>');
    ...
    //                });
        ...
        $("#styledTable").on("click", ".save-btn", function (event) {
            ...
            var amountRemaining = amountneeded - amountValue;
//            // Create the content to print
//            var printContent = `
//    ****************************************
//    **            PAYMENT RECEIPT          **
...
//            printReceipt(printContent);
    ...
    `;
        ...
        <pre style="font-family: monospace; font-size: 16px; font-weight: bold; line-height: 1.6; text-align: left; white-space: pre-wrap;">
            ${content}
        </pre>
    `);
                printWindow.document.close();
