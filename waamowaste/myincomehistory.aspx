<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="myincome.aspx.cs" Inherits="waamowaste.myincome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <select class="form-control" id="waxid">
          <option value="">Xaafadaha Dhan</option>
      </select>
  </div>
    ...
    <select class="form-control" id="stt">
        <option value="">Select Status</option>
               ...
               <option value="0">Not Paid</option>
                ...
                <br />
                                ...
                                <button id="searchbtn" type="button" class="btn btn-success" ><i class="fas fa-plus"></i> Search</button>
            </div>
     ...
     <div class="col-lg-12 col-md-6 mb-4">
         <div class="card shadow-sm border-0 rounded">
             <div class="card-body">
                 <h5 class="card-title text-success text-uppercase">Total Amount</h5>
         ...
         <div class="card shadow-sm border-0 rounded">
             <div class="card-body">
                 <h5 class="card-title text-success text-uppercase">lacagihi Hore</h5>
                 <h3 id="lacag1"  class="display-6 ">Null</h3>
             </div>
         </div>
     </div>
     ...
     <div class="col-lg-12 col-md-6 mb-4">
         <div class="card shadow-sm border-0 rounded">
             <div class="card-body">
                 <h5 class="card-title text-success text-uppercase">Total Due Amount</h5>
         ...
         <div class="card shadow-sm border-0 rounded">
             <div class="card-body">
                 <h5 class="card-title text-success text-uppercase">Lacagihi hadda</h5>
                 <h3 id="lacag2"  class="display-6 ">Null</h3>
             </div>
         </div>
     </div>
     ...
     <div class="col-lg-12 col-md-6 mb-4">
         <div class="card shadow-sm border-0 rounded">
             <div class="card-body">
                 <h5 class="card-title text-uppercase">Total Paid Amount</h5>
         ...
         <div class="card shadow-sm border-0 rounded">
             <div class="card-body">
                 <h5 class="card-title text-success text-uppercase">status</h5>
                 <h3 id="st"  class="display-6 ">Null</h3>
             </div>
         </div>
     </div>
...
<%--    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js"></script>
    ...
    <script>
        ...
        $("#stt").on("change", function () {
            const selectedDate = $(this).val(); // Get the selected date
            const selectedText = $("#stt option:selected").text();
        ...
        $(document).ready(function () {
            $('#searchbtn').on('click', function () {
                ...
                var paymentMonth = date ? new Date(date).getMonth() + 1 : null; // Months are 0-based in JavaScript
                var paymentYear = date ? new Date(date).getFullYear() : null;
