<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="sms.aspx.cs" Inherits="waamowaste.sms" %>
    ...
    <select class="form-control" id="stt">
        ...
        <div class="form-container">
            <h2>Send SMS</h2>
                ...
                <button type="button" id="sendSMSButton" onclick="sendMessage()" class="btn custom-button btn-block">Send SMS</button>
...
<%--    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js"></script>
    ...
    <script>
        ...
        function sendMessage()
        {
            ...
            $.ajax({ type: "POST", url: "sms.aspx/SendSMS", data: JSON.stringify({ message: message }), contentType: "application/json; charset=utf-8", dataType: "json", success: function (response) { alert('Message sent successfully!'); }, error: function (error) { alert('Error sending message: ' + error.responseText); } });
        }
